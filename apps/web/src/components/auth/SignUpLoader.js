...
import { Check, Server, Cpu, Gauge } from 'lucide-react';
import { useEffect, useState } from 'react';

const steps = [
  {
    title: "Creating Account",
    description: "Setting up your secure environment",
    icon: Server,
    color: "text-blue-400",
  ...
  {
    title: "Initializing GPU Resources",
    description: "Preparing compute infrastructure",
    icon: Cpu,
  ...
  },
  {
    ...
    description: "Setting up your control panel",
    icon: Gauge,
    color: "text-lime-400",
